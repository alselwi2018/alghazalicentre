 ...
 */
final class Version20190920102735 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE complain ADD reference VARCHAR(255) NOT NULL, ADD created_date DATETIME NOT NULL, CHANGE mobile_number mobile_number INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE complain DROP reference, DROP created_date, CHANGE mobile_number mobile_number INT DEFAULT NULL');
